      ...
      <main className="overflow-scroll h-screen">
        <section className="bg-gradient-to-r from-blue-500 to-purple-400 py-12 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto px-4 py-6 sm:px-0">
            <div className="bg-white rounded-lg shadow-md shadow-slate-500 p-8 flex flex-col items-center justify-center">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2 text-center">Welcome to Vi_Expense_Tracker</h2>
              ...
              <Link to={user ? "/userExpenses" : "signup"} className="bg-purple-500 text-white py-2 px-6 rounded-lg font-semibold hover:bg-purple-500 transition duration-300">
                Get Started
              </Link>
            </div>
          </div>
        ...
        <section className="bg-blue-600 py-12">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-4 text-lg text-blue-200">Sign up now and take control of your finances with ViExpenseTracker.</p>
            <Link to={user ? "dashboard" : "/signup"} className="mt-6 inline-block bg-white text-blue-600 font-semibold py-3 px-6 rounded-lg shadow-md hover:bg-gray-100">
              Register Now
            </Link>
          </div>
        </section>
